...
#include "shr_assert.h"
  ...
  use landunit_varcon, only : istsoil, istsoil_li, istsoil_mi, istsoil_hi, istcrop, istdlak, istwet, max_lunit !KSA2019
...
contains
  ...
  subroutine update_landunit_weights_one_gcell(landunit_weights)
    ...
    integer, parameter :: decrease_order(10) = &   !KSA2019
         (/istsoil, istcrop, isturb_md, isturb_hd, isturb_tbd, istwet, istdlak, istsoil_li, istsoil_mi, istsoil_hi/)
